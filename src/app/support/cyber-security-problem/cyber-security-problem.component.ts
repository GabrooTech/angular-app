...
@Component({
  selector: 'app-cyber-security-problem',
  templateUrl: './cyber-security-problem.component.html',
  styleUrl: './cyber-security-problem.component.css'
})
export class CyberSecurityProblemComponent implements OnDestroy{
